...
![](https://github.com/comerc/openspec-to-beads/blob/main/assets/image.png?raw=true)
...
См. предыдущую заметку [про OpenSpec](https://habr.com/ru/articles/983062/) без Beads. И наверно надо было попробовать поюзать Beads отдельно сначала. Очень тяжело зашло скрещивание.

> Разработчик с новой технологией - как маньяк с бензопилой, который носится по этажам психбольницы и пытается везде её применить.
